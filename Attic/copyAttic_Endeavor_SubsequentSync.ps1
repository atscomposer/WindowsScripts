...
foreach ($dir in $dirs)
{
    ...
    Start-Job -Name "Attic Endeavor Copy $folder" -ScriptBlock {
       robocopy $args[0] $args[1] /E /B /XO /COPY:DAT /DCOPY:T /R:0 /W:0 /FP /MT:100 /LOG+:"C:\Users\sd_ashuttleworth\Desktop\Endeavor\SubsequentSync\ATTIC_Endeavor_SubsequentSync2_$($args[2]).log"
