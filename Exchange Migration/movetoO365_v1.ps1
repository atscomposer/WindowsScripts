...
$groups = @(Get-ADGroup -Filter * -SearchBase "OU=Exchange Migration Project,OU=*IT Use Only - Internal,OU=iRobot Users,DC=wardrobe,DC=irobot,DC=com" | where-object {$_.Name -ne "O365 Migration Team"} | Select-Object -ExpandProperty Name)
